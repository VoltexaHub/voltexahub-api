<template>
  <div class="rounded-lg overflow-hidden border border-vp-border dark:border-vp-dark-border">
    ...
    <div class="relative">
      ...
      <pre class="p-4 overflow-x-auto text-sm leading-relaxed" :style="{ background: isDark ? '#0f172a' : '#f3f4f6' }"><code ref="codeEl" :class="langClass" v-html="highlightedCode"></code></pre>
    </div>
  </div>
</template>
